...
export const en = {
  ...
  'guitarGuide.layout': 'Fretboard layout',
  'guitarGuide.horizontal': 'Horizontal fretboard',
  'guitarGuide.vertical': 'Vertical fretboard',
  'guitarGuide.horizontalShort': 'Horizontal',
  'guitarGuide.verticalShort': 'Vertical',
  'guitarGuide.side': 'Panel side',
  'guitarGuide.left': 'Left',
  'guitarGuide.right': 'Right',
  'guitarGuide.moveLeft': 'Move vertical fretboard to the left',
  'guitarGuide.moveRight': 'Move vertical fretboard to the right',
  'guitarGuide.chordHint': 'Play 2+ notes to see the chord above.',
  'guitarGuide.nowPlaying': 'Now playing',
  'guitarGuide.stringShort': 'S',
  'guitarGuide.fretShort': 'F',
  'guitarGuide.visibleFrets': 'Visible frets',
  'guitarGuide.outsideView': 'Outside the visible fret range',
  'guitarGuide.positionContext': 'Use the fretboard to see the exact location.',
