...
const es: Messages = {
  ...
  'guitarGuide.layout': 'Disposición del diapasón',
  'guitarGuide.horizontal': 'Diapasón horizontal',
  'guitarGuide.vertical': 'Diapasón vertical',
  'guitarGuide.horizontalShort': 'Horizontal',
  'guitarGuide.verticalShort': 'Vertical',
  'guitarGuide.side': 'Lado del panel',
  'guitarGuide.left': 'Izquierda',
  'guitarGuide.right': 'Derecha',
  'guitarGuide.moveLeft': 'Mover el diapasón vertical a la izquierda',
  'guitarGuide.moveRight': 'Mover el diapasón vertical a la derecha',
  'guitarGuide.chordHint': 'Toca 2 o más notas para ver el acorde arriba.',
  'guitarGuide.nowPlaying': 'Sonando ahora',
  'guitarGuide.stringShort': 'C',
  'guitarGuide.fretShort': 'T',
  'guitarGuide.visibleFrets': 'Trastes visibles',
  'guitarGuide.outsideView': 'Fuera del rango de trastes visible',
  'guitarGuide.positionContext': 'Usa el diapasón para ver la ubicación exacta.',
