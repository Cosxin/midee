...
const fr: Messages = {
  ...
  'guitarGuide.layout': 'Disposition du manche',
  'guitarGuide.horizontal': 'Manche horizontal',
  'guitarGuide.vertical': 'Manche vertical',
  'guitarGuide.horizontalShort': 'Horizontal',
  'guitarGuide.verticalShort': 'Vertical',
  'guitarGuide.side': 'Côté du panneau',
  'guitarGuide.left': 'Gauche',
  'guitarGuide.right': 'Droite',
  'guitarGuide.moveLeft': 'Déplacer le manche vertical à gauche',
  'guitarGuide.moveRight': 'Déplacer le manche vertical à droite',
  'guitarGuide.chordHint': 'Jouez au moins 2 notes pour voir l’accord au-dessus.',
  'guitarGuide.nowPlaying': 'En cours',
  'guitarGuide.stringShort': 'C',
  'guitarGuide.fretShort': 'F',
  'guitarGuide.visibleFrets': 'Frettes visibles',
  'guitarGuide.outsideView': 'Hors de la plage de frettes visible',
  'guitarGuide.positionContext': "Utilisez le manche pour voir l'emplacement exact.",
