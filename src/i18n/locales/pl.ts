...
const pl: Messages & Record<PolishPluralKey, string> = {
  ...
  'guitarGuide.layout': 'Układ gryfu',
  'guitarGuide.horizontal': 'Gryf poziomy',
  'guitarGuide.vertical': 'Gryf pionowy',
  'guitarGuide.horizontalShort': 'Poziomo',
  'guitarGuide.verticalShort': 'Pionowo',
  'guitarGuide.side': 'Strona panelu',
  'guitarGuide.left': 'Lewa',
  'guitarGuide.right': 'Prawa',
  'guitarGuide.moveLeft': 'Przenieś pionowy gryf na lewo',
  'guitarGuide.moveRight': 'Przenieś pionowy gryf na prawo',
  'guitarGuide.chordHint': 'Zagraj co najmniej 2 nuty, aby zobaczyć akord powyżej.',
  'guitarGuide.nowPlaying': 'Teraz gra',
  'guitarGuide.stringShort': 'S',
  'guitarGuide.fretShort': 'P',
  'guitarGuide.visibleFrets': 'Widoczne progi',
  'guitarGuide.outsideView': 'Poza widocznym zakresem progów',
  'guitarGuide.positionContext': 'Użyj gryfu, aby zobaczyć dokładne położenie.',
