...
const pl: Messages & Record<PolishPluralKey, string> = {
  ...
  'visualization.piano.label': 'Pianino',
  'visualization.piano.aria': 'Pokaż wizualizację pianina',
  'visualization.guitar.label': 'Gitara',
  'visualization.guitar.aria': 'Pokaż wizualizację gitary',
  'visualization.learnPianoRequired': 'Ta aktywność nauki wymaga widoku pianina.',
