...
const ptBR: Messages = {
  ...
  'guitarGuide.layout': 'Orientação do braço',
  'guitarGuide.horizontal': 'Braço horizontal',
  'guitarGuide.vertical': 'Braço vertical',
  'guitarGuide.horizontalShort': 'Horizontal',
  'guitarGuide.verticalShort': 'Vertical',
  'guitarGuide.side': 'Lado do painel',
  'guitarGuide.left': 'Esquerda',
  'guitarGuide.right': 'Direita',
  'guitarGuide.moveLeft': 'Mover o braço vertical para a esquerda',
  'guitarGuide.moveRight': 'Mover o braço vertical para a direita',
  'guitarGuide.chordHint': 'Toque 2 ou mais notas para ver o acorde acima.',
  'guitarGuide.nowPlaying': 'Tocando agora',
  'guitarGuide.stringShort': 'C',
  'guitarGuide.fretShort': 'F',
  'guitarGuide.visibleFrets': 'Casas visíveis',
  'guitarGuide.outsideView': 'Fora da faixa de casas visível',
  'guitarGuide.positionContext': 'Use o braço para ver a posição exata.',
