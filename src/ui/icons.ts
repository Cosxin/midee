...
export const icons = {
  ...
  layoutHorizontal: (size: Size = 14): string =>
    svgStroke(
      size,
      `<rect x="3" y="5" width="18" height="14" rx="2"/><path d="M6 15h12M8 8v8M12 8v8M16 8v8"/>`,
      1.6,
      'aria-hidden="true"',
    ),

  layoutVertical: (size: Size = 14): string =>
    svgStroke(
      size,
      `<rect x="5" y="3" width="14" height="18" rx="2"/><path d="M8 6v12M8 8h8M8 12h8M8 16h8"/>`,
      1.6,
      'aria-hidden="true"',
    ),

  swapSides: (size: Size = 14): string =>
    svgStroke(
      size,
      `<path d="M4 7h16M7 4 4 7l3 3M20 17H4M17 14l3 3-3 3"/>`,
      1.8,
      'aria-hidden="true"',
    ),
